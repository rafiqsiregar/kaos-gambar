    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                    ...
                    <div class="bg-white overflow-auto p-5">
                        <div class="container">
                            <div class="grid lg:grid-cols-2 sm:grid-cols-1 gap-4">
                                ...
                                <div class="mb-4">
                                    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" id="addProduct"><i class="fas fa-plus"></i> Add Product</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="w-full mt-12 shadow-lg">
                    <p class="text-xl pb-3 flex items-center p-5 bg-white">
                        <i class="fas fa-list mr-3"></i> All Product
                    </p>
                    <div class="bg-white overflow-auto p-5">
        ...
        <script>
            ...
            $('#addProduct').click(function(){
                ...
                var urls = '<?=base_url()?>v1/product/create';
            ...
            function getListProduct() {
                var urls = '<?=base_url()?>v1/product/all';
                        ...
                        if(res.type == 'success'){
                            ...
                            data.forEach((row)=>{
                                ...
                                productList.row.add( [
                                    ...
                                    row.price,
                                    row.description,
                                    '<a href="/admin/product/edit/'+row.id+'" class="py-2 px-4 bg-teal-400 text-white font-bold rounded">Edit</a>&nbsp;<a href="javascript:void(0)" onclick="DeleteProduct('+row.id+')" class="py-2 px-4 bg-orange-400 text-white font-bold rounded">Hapus</a>'
                                ] ).draw( false );
            ...
            function DeleteProduct(id = 0){
                var url = '<?=base_url()?>v1/product/delete';
